  ...
  public class Reserva
  {
    ...
    public void CadastrarHospedes(List<Pessoa> hospedes)
    {
      ...
      else
      {
        ...
        throw new Exception("Capacidade menor que o número de hóspedes permitidos.");
      }
    }
    ...
    public decimal CalcularValorDiaria()
    {
      ...
      // DONE: Regra: Caso os dias reservados forem maior ou igual a 10, conceder um desconto de 10%
      if (DiasReservados >= 10)
      {
        decimal desconto = valor / 100 * 10;
        decimal novoValor = (DiasReservados * Suite.ValorDiaria) - desconto;
        valor = novoValor;
      }
